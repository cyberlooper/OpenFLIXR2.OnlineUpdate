...
$count = "100"; //ammount of recenly added results  - YOU DONT HAVE TO CHANGE THIS
...
//end check
?>
<div><th><span style="z-index:3;position:absolute;padding-left:7px;padding-top:10px;"><span class="label label-success"><?php echo $rating;?></span></span><a href="<?php echo $url;?>" target="_blank"/>
...
echo "<td style=\"padding-top: 0;\">". $output_tlt. "</td>";
